...
public class CMD_PathfindCloseReefAlign extends Command {
  ...
  public CMD_PathfindCloseReefAlign(SUB_Drivetrain drivetrain, SUB_PhotonVision photonVision,
      boolean isLeftAlign) {
  ...
  public void initialize() {
    ...
    if (alliance.isPresent()) {
      targetTagSet =
          alliance.get() == DriverStation.Alliance.Red ? Arrays.asList(10,11,6,7,8,9)
