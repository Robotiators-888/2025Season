...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    Driver2.leftBumper()
        .toggleOnTrue(
            new RunCommand(() -> roller.setOutput(Roller.kIntakeSpeed), roller).withTimeout(Roller.kIntakeStartingTime)
                .andThen(new RunCommand(() -> roller.setOutput(Roller.kIntakeSpeed), roller))
    ...
    Driver2.rightBumper().whileTrue(
        new RunCommand(() -> roller.setOutput(Roller.kEjectSpeed), roller).finallyDo(() -> roller.hasCoral(false)));
  }
