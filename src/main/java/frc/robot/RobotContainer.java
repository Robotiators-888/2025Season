...
import frc.robot.utils.ElevatorManager;
...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                NamedCommands.registerCommand("scoreL4(conditional)", new ParallelRaceGroup(new SequentialCommandGroup(
                                ...
                                new RunCommand(() -> roller
                                                .setRollerOutput(Roller.kEjectSpeed - 0.1), roller)
                                                .withTimeout(.15))
                                .withTimeout(4), Commands.waitUntil(() -> !autoGenerator.getintakecomplete())));
                                ...
                                new ParallelRaceGroup(
                                                new SequentialCommandGroup(
                                                                ...
                                                                .andThen(new RunCommand(
                                                                                ...
                                                                                .andThen(new InstantCommand(() -> roller
                                                                                                .setRollerOutput(0, 0))
                                                                                                .andThen(new InstantCommand(
                                                                                                                () -> autoGenerator
                                                                                                                                .setintakecomplete(
                                                                                                                                                true))))),
                                                new SequentialCommandGroup(new WaitCommand(4), new InstantCommand(
                                                                () -> autoGenerator.setintakecomplete(false)))));
        ...
        private void configureBindings() {
                ...
                Driver2.povUp().onTrue(getL2AlgaeSetpointCommand());
                Driver2.povDown().onTrue(getL1AlgaeSetpointCommand());
                ...
                Driver2.leftBumper().whileTrue(new RunCommand(
                                () -> roller.setRollerOutput(-Roller.kIntakeSpeed, -Roller.kRollerHelperSpeed)))
                                .onFalse(new InstantCommand(() -> roller.setRollerOutput(0.0, 0.0)));
        ...
        public Command getProcessorSetpointCommand() {
                Command c = new ParallelRaceGroup(new SequentialCommandGroup(new InstantCommand(
                                () -> {
                                        ScoringSetpoint currentSetpoint = ElevatorManager.getCurrentSetpoint();
                                        pivot.changeSetpoint(ElevatorManager.getSafeElevatingSetpoint(currentSetpoint,
                                                        CollisionAvoidance.processorSetpoint));
                                }),
                                new InstantCommand(() -> elevator
        ...
        public Command getBargeSetpointCommand() {
                Command c = new ParallelRaceGroup(new SequentialCommandGroup(new InstantCommand(
                                () -> {
                                        ScoringSetpoint currentSetpoint = ElevatorManager.getCurrentSetpoint();
                                        pivot.changeSetpoint(ElevatorManager.getSafeElevatingSetpoint(currentSetpoint,
                                                        CollisionAvoidance.bargeSetpoint));
                                }),
                                new InstantCommand(() -> elevator
                                                .ChangeSetpoint(Elevator.kL4Setpoint)),
                                Commands.waitUntil(() -> elevator.atSetpoint(0.0))
        ...
        public Command getBargeScoringCommand() {
                Command c = new ParallelRaceGroup(new SequentialCommandGroup(new InstantCommand(
                                ...
                                new InstantCommand(() -> pivot
                                                .changeSetpoint(240)), // 250 Is close to when the bottom of the
                                                                       // manuipulator collides with the top of the
                                                                       // elevator.
                                new ParallelRaceGroup(new SequentialCommandGroup(
                                                Commands.waitUntil(() -> pivot.atSetpoint(231.5)), // Here 250 Is used
                                                                                                   // as a kind of
                                                                                                   // default value,
                                                                                                   // will have to be
                                                                                                   // tested.
        ...
        public Command getL2AlgaeSetpointCommand() {
                Command c = new ParallelRaceGroup(new SequentialCommandGroup(new InstantCommand(
                                () -> {
                                        ScoringSetpoint currentSetpoint = ElevatorManager.getCurrentSetpoint();
                                        pivot.changeSetpoint(ElevatorManager.getSafeElevatingSetpoint(currentSetpoint,
                                                        CollisionAvoidance.l2AlgaeSetpoint));
                                }),
                                new InstantCommand(() -> elevator
        ...
        public Command getL1AlgaeSetpointCommand() {
                Command c = new ParallelRaceGroup(new SequentialCommandGroup(new InstantCommand(
                                () -> {
                                        ScoringSetpoint currentSetpoint = ElevatorManager.getCurrentSetpoint();
                                        pivot.changeSetpoint(ElevatorManager.getSafeElevatingSetpoint(currentSetpoint,
                                                        CollisionAvoidance.l1AlgaeSetpoint));
                                }),
                                new InstantCommand(() -> elevator
        ...
        public Command getAutonomousCommand() {
                ...
                // return auto;
                // drivetrain.resetPose(new Pose2d(2.0, 3.0, new
