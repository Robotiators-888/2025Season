...
public class RobotContainer {
        ...
        public RobotContainer() {
            ...
            drivetrain.setDefaultCommand(new RunCommand(() -> drivetrain.drive(
                -Math.pow(0.1*MathUtil.applyDeadband(Driver1.getRawAxis(1), OperatorConstants.kDriveDeadband),2),
                -Math.pow(0.1*MathUtil.applyDeadband(Driver1.getRawAxis(0), OperatorConstants.kDriveDeadband),2),
                -Math.pow(0.1*MathUtil.applyDeadband(Driver1.getRawAxis(4), OperatorConstants.kDriveDeadband),2), true,
                true), drivetrain));
