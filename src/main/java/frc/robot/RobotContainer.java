...
NamedCommands.registerCommand("Pivotdown", new ParallelCommandGroup(
    new InstantCommand(() -> groundPivot.changeSetpoint(GroundPivot.kIntakePos)),
    new InstantCommand(() -> SUB_GroundIntake.getInstance().setGroundIntake(GroundIntake.kGroundIntakeSpeed))
));

NamedCommands.registerCommand("Scoringpose", new InstantCommand(
    () -> groundPivot.changeSetpoint(GroundPivot.kScorePos)
));

NamedCommands.registerCommand("Outtake", new RunCommand(() -> groundIntake
.setGroundIntake(GroundIntake.kGroundEjectSpeed)));
        ...
        private void configureBindings() {
                ...
                Driver1.povRight().whileTrue(new CMD_DriveToClosestGroundObject(drivetrain, photonVision));
